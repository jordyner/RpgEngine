...
public class MenuUI {
    ...
    /**
    * First thing players sees when he launches the same. He can choose if he wants to create new game or just load last saved game. He can also exit program.
    * 
    ...
    */
    ...
    /**
     * Buttons have to updated because if player changes resolution it would display in an different way.
     */
